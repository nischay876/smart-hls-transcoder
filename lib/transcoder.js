...
async function processWithConcurrencyLimit(qualities, sourceInfo, inputFile, output, segmentDuration, preset, bandwidthRatio, crfOffset, maxConcurrent, gpuConfig, gpuName) {
  const results = [];
...
async function processQualityLevel(options) {
  const { quality, sourceInfo, inputFile, output, segmentDuration, preset, bandwidthRatio, crfOffset, gpuConfig, gpuName, showProgressInNewLine } = options;
